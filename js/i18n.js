...
(function (global) {
  ...
  var translations = {
    es: {
      ...
      "meta.description":
        "Bar y restaurante del Club Pádel Sabor en Palma de Mallorca (Ponent). Tapas, burgers y ambiente de club. Carta digital y WhatsApp.",
      "meta.cartaTitle": "Carta Digital — Club Pádel Sabor | Palma",
      "meta.cartaDescription":
        "Carta digital del bar Club Pádel Sabor en Palma: para picar, burgers, bebidas y postres tras el partido.",
      "nav.home": "Inicio",
      ...
      "hero.subtitle":
        "En Palma de Mallorca: tapas, burgers y buen ambiente tras cada partido en Ponent.",
      ...
      "hours.address": "Carrer d'Andalusia · Ponent · 07013 Palma, Illes Balears",
      "ig.kicker": "Comunidad",
      "ig.title": "Vive el club también en Instagram",
      "ig.subtitle": "Partidos, platos del día, stories de terraza y ambiente en Palma. Dale like y no te pierdas nada.",
      "ig.cta": "Seguir @clubpadelsabor",
      "ig.hint": "Fotos reales del bar, la pista y lo que se cuece en cocina.",
      "footer.tagline": "Bar & restaurante del club en Palma. Sabor tras cada set.",
      ...
      "carta.back": "Volver",
      "carta.ig": "Ver platos en Instagram",
    ...
    ca: {
      ...
      "meta.description":
        "Bar i restaurant del Club Pàdel Sabor a Palma (Ponent). Tapes, burgers i ambient de club. Carta digital i WhatsApp.",
      "meta.cartaTitle": "Carta Digital — Club Pàdel Sabor | Palma",
      "meta.cartaDescription":
        "Carta digital del bar Club Pàdel Sabor a Palma: per picar, burgers, begudes i postres després del partit.",
      "nav.home": "Inici",
      ...
      "hero.subtitle":
        "A Palma de Mallorca: tapes, burgers i bon ambient després de cada partit a Ponent.",
      "hero.ctaMenu": "Veure Carta Digital",
      "hero.ctaWhatsapp": "Contacte / WhatsApp",
      "hero.ctaInstagram": "Segueix-nos a Instagram",
      ...
      "hours.address": "Carrer d'Andalusia · Ponent · 07013 Palma, Illes Balears",
      "ig.kicker": "Comunitat",
      "ig.title": "Viu el club també a Instagram",
      "ig.subtitle": "Partits, plats del dia, stories de terrassa i ambient a Palma. Fes like i no et perdis res.",
      "ig.cta": "Seguir @clubpadelsabor",
      "ig.hint": "Fotos reals del bar, la pista i el que es cou a cuina.",
      "footer.tagline": "Bar & restaurant del club a Palma. Sabor després de cada set.",
      ...
      "carta.back": "Tornar",
      "carta.ig": "Veure plats a Instagram",
    ...
    en: {
      ...
      "meta.description":
        "Bar and restaurant at Club Pádel Sabor in Palma de Mallorca (Ponent). Tapas, burgers and club vibes. Digital menu and WhatsApp.",
      "meta.cartaTitle": "Digital Menu — Club Pádel Sabor | Palma",
      "meta.cartaDescription":
        "Digital menu at Club Pádel Sabor in Palma: snacks, burgers, drinks and desserts after your match.",
      "nav.home": "Home",
      ...
      "hero.subtitle":
        "In Palma de Mallorca: tapas, burgers and great vibes after every match in Ponent.",
      ...
      "hours.address": "Carrer d'Andalusia · Ponent · 07013 Palma, Illes Balears",
      "ig.kicker": "Community",
      "ig.title": "Follow the club on Instagram",
      "ig.subtitle": "Matches, daily specials, terrace stories and Palma vibes. Hit follow so you never miss a set.",
      "ig.cta": "Follow @clubpadelsabor",
      "ig.hint": "Real shots of the bar, the court and what's cooking.",
      "footer.tagline": "The club bar & restaurant in Palma. Flavour after every set.",
      ...
      "carta.back": "Back",
      "carta.ig": "See dishes on Instagram",
    ...
    de: {
      "meta.title": "Club Pádel Sabor — Bar & Restaurant",
      "meta.description":
        "Bar und Restaurant im Club Pádel Sabor in Palma de Mallorca (Ponent). Tapas, Burger und Club-Atmosphäre. Digitale Karte und WhatsApp.",
      "meta.cartaTitle": "Digitale Speisekarte — Club Pádel Sabor | Palma",
      "meta.cartaDescription":
        "Digitale Speisekarte der Bar Club Pádel Sabor in Palma: Snacks, Burger, Getränke und Desserts nach dem Match.",
      "nav.home": "Start",
      ...
      "hero.subtitle":
        "In Palma de Mallorca: Tapas, Burger und gute Stimmung nach jedem Match in Ponent.",
      ...
      "hours.address": "Carrer d'Andalusia · Ponent · 07013 Palma, Illes Balears",
      "ig.kicker": "Community",
      "ig.title": "Folge dem Club auf Instagram",
      "ig.subtitle": "Matches, Tagesgerichte, Terrassen-Stories und Palma-Vibes. Folge uns, damit du keinen Satz verpasst.",
      "ig.cta": "@clubpadelsabor folgen",
      "ig.hint": "Echte Fotos von Bar, Platz und Küche.",
      "footer.tagline": "Bar & Restaurant des Clubs in Palma. Geschmack nach jedem Satz.",
      ...
      "carta.back": "Zurück",
      "carta.ig": "Gerichte auf Instagram",
